...
const CACHE_NAME = 'turnos-tef-shell-v3';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
...
// cache:'no-store' é essencial aqui: sem isto, o próprio browser pode responder com uma
// cópia antiga guardada na sua cache HTTP normal, sem sequer confirmar com o servidor.
